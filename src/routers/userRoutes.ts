...
import { addUser, getAllUsers, getUserById, getUserByEmail, updateUser, deleteUser, signIn, forgotPassword, resetPassword, getSignedInUser } from "../controllers/userController";
...
userRoutes.get('/user', accountRequired, getSignedInUser)
